...
const styles = StyleSheet.create({
  card: { backgroundColor: '#fff', borderRadius: 12, padding: 20, borderWidth: 1, borderColor: '#eee', minHeight: 280 },
  title: { fontSize: 16, fontWeight: '700', color: '#111827', marginBottom: 12 },
  chartRow: { flexDirection: 'row', alignItems: 'flex-end', gap: 16, height: 220, padding: 12 },
